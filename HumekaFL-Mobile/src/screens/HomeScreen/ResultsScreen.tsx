    ...
    return (
        <SafeAreaView style={{backgroundColor: 'white', flex: 1}}>
            <View style={styles.container}>
                ...
                <Text style={styles.subTitle}>{situation === false ? 'The baby is in' : situation === true ? '\n The baby is in' : 'Please record the audio'}</Text>
                <Text style={styles.result}>{situation === false ? 'Perfect condition' : situation === true ? 'Perfect condition' : 'Again=='}</Text>
